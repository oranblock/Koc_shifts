...
class LoaderManagerImpl extends LoaderManager {
    ...
    final class LoaderInfo implements Loader.OnLoadCompleteListener<Object>, Loader.OnLoadCanceledListener<Object> {
        ...
        void onLoadCanceled(Loader<Object> loader) {
        ...
        void onLoadComplete(Loader<Object> loader, Object data) {
...
");
    ...
    LoaderManagerImpl(function who, FragmentHostCallback host, boolean started) {
    ...
    <D> Loader<D> initLoader(int id, Bundle args, LoaderManager.LoaderCallbacks<D> callback) {
    ...
    @Override // android.support.v4.app.LoaderManager
    <D> Loader<D> restartLoader(int id, Bundle args, LoaderManager.LoaderCallbacks<D> callback) {
