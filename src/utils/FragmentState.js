...
final class FragmentState implements Parcelable {
    ...
    static final Parcelable.Creator<FragmentState> CREATOR = new Parcelable.Creator<FragmentState>() {
 // from class: android.support.v4.app.FragmentState.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        FragmentState createFromParcel(Parcel in) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        FragmentState[] newArray(int size) {
...
;
    ...
    Fragment instantiate(FragmentHostCallback host, Fragment parent) {
