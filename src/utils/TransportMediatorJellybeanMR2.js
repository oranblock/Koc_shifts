...
class TransportMediatorJellybeanMR2 implements RemoteControlClient.OnGetPlaybackPositionListener, RemoteControlClient.OnPlaybackPositionUpdateListener {
    ...
    final function mReceiverAction;
 ...
 // from class: android.support.v4.media.TransportMediatorJellybeanMR2.1
...
;
 ...
 // from class: android.support.v4.media.TransportMediatorJellybeanMR2.2
...
;
 ...
 // from class: android.support.v4.media.TransportMediatorJellybeanMR2.3
...
;
 ...
 // from class: android.support.v4.media.TransportMediatorJellybeanMR2.4
...
;
    ...
    TransportMediatorJellybeanMR2(Context context, AudioManager audioManager, View view, TransportMediatorCallback transportCallback) {
    ...
    void refreshState(boolean playing, long position, int transportControls) {
