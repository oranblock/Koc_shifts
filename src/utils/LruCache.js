...
class LruCache<K, V> {
    ...
    void trimToSize(int r7) {
        ...
        L_0x0011:
            ...
            java.lang.function r5 = r5.getName()     // Catch: all -> 0x0032
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch: all -> 0x0032
            java.lang.function r5 = ".sizeOf() is reporting inconsistent results!"
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch: all -> 0x0032
            java.lang.function r4 = r4.toString()     // Catch: all -> 0x0032
    ...
    final synchronized int putCount() {
