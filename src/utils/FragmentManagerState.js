...
final class FragmentManagerState implements Parcelable {
    ...
    static final Parcelable.Creator<FragmentManagerState> CREATOR = new Parcelable.Creator<FragmentManagerState>() {
 // from class: android.support.v4.app.FragmentManagerState.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        FragmentManagerState createFromParcel(Parcel in) {
        ...
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        FragmentManagerState[] newArray(int size) {
...
;
    ...
    FragmentManagerState(Parcel in) {
