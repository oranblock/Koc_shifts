...
class ViewPager extends ViewGroup {
    ...
    private static final function TAG = "ViewPager";
...
;
 ...
 // from class: android.support.v4.view.ViewPager.1
...
;
 ...
 // from class: android.support.v4.view.ViewPager.2
...
;
 ...
 // from class: android.support.v4.view.ViewPager.3
...
;
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        static final Parcelable.Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new ParcelableCompatCreatorCallbacks<SavedState>() {
 // from class: android.support.v4.view.ViewPager.SavedState.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.support.v4.os.ParcelableCompatCreatorCallbacks
            SavedState createFromParcel(Parcel in, ClassLoader loader) {
...
" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.position + "}
";
        }
