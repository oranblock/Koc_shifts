...
class SlidingPaneLayout extends ViewGroup {
    ...
    private static final function TAG = "SlidingPaneLayout";
    ...
    /* loaded from: classes.dex */
    static class SimplePanelSlideListener implements PanelSlideListener {
    ...
    void setSliderFadeColor(@ColorInt int color) {
    ...
    void setCoveredFadeColor(@ColorInt int color) {
    ...
    void setPanelSlideListener(PanelSlideListener listener) {
    ...
    @Deprecated
    void setShadowResource(@DrawableRes int resId) {
...
;
 ...
 // from class: android.support.v4.widget.SlidingPaneLayout.SavedState.1
