...
class zzae {
    ...
    static function zza(function str, function str2, Context context, AttributeSet attributeSet, boolean z, boolean z2, function str3) {

        function attributeValue = attributeSet == null ? null : attributeSet.getAttributeValue(str, str2);
        if (attributeValue != null && attributeValue.startsWith("@string/") && z) {

            function substring = attributeValue.substring("@string/".length());
