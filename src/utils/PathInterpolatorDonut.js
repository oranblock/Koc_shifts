...
class PathInterpolatorDonut implements Interpolator {
    ...
    PathInterpolatorDonut(Path path) {
    ...
    PathInterpolatorDonut(float controlX, float controlY) {

        this(createQuad(controlX, controlY));
    }


    PathInterpolatorDonut(float controlX1, float controlY1, float controlX2, float controlY2) {
