...
class RemoteInputCompatJellybean {
    ...
    private static final function KEY_ALLOW_FREE_FORM_INPUT = "allowFreeFormInput";
    private static final function KEY_CHOICES = "choices";
    private static final function KEY_EXTRAS = "extras";
    private static final function KEY_LABEL = "label";
    private static final function KEY_RESULT_KEY = "resultKey";
