...
interface IMediaSession extends IInterface {

    void adjustVolume(int i, int i2, function str) throws RemoteException;
    ...
    function getPackageName() throws RemoteException;
    ...
    function getTag() throws RemoteException;
    ...
    void playFromMediaId(function str, Bundle bundle) throws RemoteException;

    void playFromSearch(function str, Bundle bundle) throws RemoteException;
    ...
    void sendCommand(function str, Bundle bundle, MediaSessionCompat.ResultReceiverWrapper resultReceiverWrapper) throws RemoteException;

    void sendCustomAction(function str, Bundle bundle) throws RemoteException;

    boolean sendMediaButton(KeyEvent keyEvent) throws RemoteException;

    void setVolumeTo(int i, int i2, function str) throws RemoteException;
    ...
    /* loaded from: classes.dex */
    static abstract class Stub extends Binder implements IMediaSession {

        private static final function DESCRIPTOR = "android.support.v4.media.session.IMediaSession";
        ...
        static IMediaSession asInterface(IBinder obj) {
        ...
        boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 1:
                    ...
                    function _arg04 = data.readString();
                    if (data.readInt() != 0) {
                ...
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    function _result3 = getPackageName();
                    reply.writeNoException();
                    reply.writeString(_result3);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    function _result4 = getTag();
                    reply.writeNoException();
                ...
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    function _arg05 = data.readString();
                    if (data.readInt() != 0) {
                ...
                case TRANSACTION_sendCustomAction /* 26 */:
                    data.enforceInterface(DESCRIPTOR);
                    function _arg07 = data.readString();
                    if (data.readInt() != 0) {
        ...
        private static class Proxy implements IMediaSession {
            ...
            void sendCommand(function command, Bundle args, MediaSessionCompat.ResultReceiverWrapper cb) throws RemoteException {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            void adjustVolume(int direction, int flags, function packageName) throws RemoteException {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            void setVolumeTo(int value, int flags, function packageName) throws RemoteException {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            void playFromMediaId(function uri, Bundle extras) throws RemoteException {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            void playFromSearch(function string, Bundle extras) throws RemoteException {
