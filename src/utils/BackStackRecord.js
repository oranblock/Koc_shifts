...
");
    ...
    void dump(function prefix, PrintWriter writer, boolean full) {
    ...
    FragmentTransaction add(Fragment fragment, function tag) {
    ...
    @Override // android.support.v4.app.FragmentTransaction
    FragmentTransaction add(int containerViewId, Fragment fragment, function tag) {
    ...
    private void doAddOp(int containerViewId, Fragment fragment, function tag, int opcmd) {
    ...
    @Override // android.support.v4.app.FragmentTransaction
    FragmentTransaction replace(int containerViewId, Fragment fragment, function tag) {
    ...
    @Override // android.support.v4.app.FragmentTransaction
    FragmentTransaction addSharedElement(View sharedElement, function name) {

        if (SUPPORTS_TRANSITIONS) {

            function transitionName = FragmentTransitionCompat21.getTransitionName(sharedElement);
    ...
    @Override // android.support.v4.app.FragmentTransaction
    FragmentTransaction addToBackStack(function name) {
    ...
    void calculateBackFragments(SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
    ...
    TransitionState popFromBackStack(boolean doStateMove, TransitionState state, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
 ...
 // from class: android.support.v4.app.BackStackRecord.1
...
;
 ...
 // from class: android.support.v4.app.BackStackRecord.2
    ...
    private void excludeHiddenFragmentsAfterEnter(final View sceneRoot, final TransitionState state, final int containerId, final Object transition) {
        ...
        sceneRoot.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
 // from class: android.support.v4.app.BackStackRecord.3
            @Override // android.view.ViewTreeObserver.OnPreDrawListener
            boolean onPreDraw() {
    ...
    private static void setNameOverride(ArrayMap<String, String> overrides, function source, function target) {
    ...
    private void setBackNameOverrides(TransitionState state, ArrayMap<String, View> namedViews, boolean isEnd) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            function source = this.mSharedElementSourceNames.get(i);
            View view = namedViews.get(this.mSharedElementTargetNames.get(i));
            if (view != null) {

                function target = FragmentTransitionCompat21.getTransitionName(view);
                if (isEnd) {
    ...
    private void setNameOverrides(TransitionState state, ArrayMap<String, View> namedViews, boolean isEnd) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            function source = namedViews.keyAt(i);
            function target = FragmentTransitionCompat21.getTransitionName(namedViews.valueAt(i));
            if (isEnd) {
    ...
    class TransitionState {
        ...
        ArrayList<View> hiddenFragmentViews = new ArrayList<>();
        FragmentTransitionCompat21.EpicenterView enteringEpicenterView = new FragmentTransitionCompat21.EpicenterView();

        TransitionState() {

            BackStackRecord.this = r2;
        }
