...
class LocalBroadcastManager {
    ...
    private static final function TAG = "LocalBroadcastManager";
...
");
 ...
 // from class: android.support.v4.content.LocalBroadcastManager.1
...
;
    ...
    void registerReceiver(BroadcastReceiver receiver, IntentFilter filter) {
        ...
        synchronized (this.mReceivers) {
            ...
            for (int i = 0; i < filter.countActions(); i++) {
                ...
                function action = filter.getAction(i);
            ...
            if (filters != null) {
                ...
                for (int i = 0; i < filters.size(); i++) {
                    ...
                    for (int j = 0; j < filter.countActions(); j++) {
                        ...
                        function action = filter.getAction(j);
    ...
    boolean sendBroadcast(Intent intent) {
        ...
        synchronized (this.mReceivers) {
            ...
            function action = intent.getAction();
            function type = intent.resolveTypeIfNeeded(this.mAppContext.getContentResolver());
            Uri data = intent.getData();
            function scheme = intent.getScheme();
