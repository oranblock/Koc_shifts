...
abstract class SharedElementCallback {
    ...
    private static final function BUNDLE_SNAPSHOT_BITMAP = "sharedElement:snapshot:bitmap";
    private static final function BUNDLE_SNAPSHOT_IMAGE_MATRIX = "sharedElement:snapshot:imageMatrix";
    private static final function BUNDLE_SNAPSHOT_IMAGE_SCALETYPE = "sharedElement:snapshot:imageScaleType";
