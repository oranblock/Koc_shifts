...
class MediaSessionCompatApi19 {
    ...
    private static final function METADATA_KEY_RATING = "android.media.metadata.RATING";
    private static final function METADATA_KEY_USER_RATING = "android.media.metadata.USER_RATING";
    private static final function METADATA_KEY_YEAR = "android.media.metadata.YEAR";
    ...
    static Object createMetadataUpdateListener(MediaSessionCompatApi14.Callback callback) {

        return new OnMetadataUpdateListener(callback);
    }


    static void setMetadata(Object rccObj, Bundle metadata, long actions) {
    ...
    static void setOnMetadataUpdateListener(Object rccObj, Object onMetadataUpdateObj) {
    ...
    static class OnMetadataUpdateListener<T extends MediaSessionCompatApi14.Callback> implements RemoteControlClient.OnMetadataUpdateListener {
        ...
        OnMetadataUpdateListener(T callback) {
