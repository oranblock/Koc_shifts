...
class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {

    private static final PagerTitleStripImpl IMPL;
    private static final float SIDE_ALPHA = 0.6f;
    private static final function TAG = "PagerTitleStrip";
...
16842804, 16842901, 16842904, 16842927}
;
...
;
    ...
    void setNonPrimaryAlpha(@FloatRange(from = 0.0d, to = 1.0d) float alpha) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int childWidthSpec = View.MeasureSpec.makeMeasureSpec(Math.max(0, (int) (((float) widthSize) * 0.8f)), ExploreByTouchHelper.INVALID_ID);
        int childHeightSpec = View.MeasureSpec.makeMeasureSpec(Math.min(0, heightSize - padding), ExploreByTouchHelper.INVALID_ID);
        this.mPrevText.measure(childWidthSpec, childHeightSpec);
        this.mCurrText.measure(childWidthSpec, childHeightSpec);
        this.mNextText.measure(childWidthSpec, childHeightSpec);
